...
export class AuthService {
  ...
  private sanitizeUser(user: UserDocument): any {
    ...
    return {
      ...
      name: userObj.name || '',               // ✅ Safe-Gate: Fallback to empty string
      gender: userObj.gender || '',           // ✅ Safe-Gate: Fallback to empty string
      city: userObj.city || '',               // ✅ Safe-Gate: Fallback to empty string
      state: userObj.state || '',             // ✅ Safe-Gate: Fallback to empty string
      ...
      appLanguage: userObj.appLanguage || 'en',
