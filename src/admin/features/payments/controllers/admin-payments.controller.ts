...
export class AdminPaymentsController {
  ...
  async getAllTransactions(
    ...
    return this.adminPaymentsService.getAllTransactions(page, limit, { type, status, search, startDate, endDate });
  }
  ...
  async getAllPayouts(
    ...
    return this.adminPaymentsService.getAllPayouts(page, limit, { status, astrologerId });
  }
  ...
  async getCommissionSettings() {
    return this.adminPaymentsService.getCommissionSettings();
  }
