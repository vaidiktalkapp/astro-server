...
export class AdminAstrologersController {
  ...
  /**
   * PATCH /admin/astrologers/:astrologerId/gallery
   * Update astrologer gallery images
   */
  @Patch(':astrologerId/gallery')
  @RequirePermissions(Permissions.ASTROLOGERS_EDIT)
  async updateGallery(
    @Param('astrologerId') astrologerId: string,
    @CurrentAdmin() admin: any,
    ...
    return this.adminAstrologersService.updateGallery(astrologerId, admin._id, gallery);
  }

  /**
   * PATCH /admin/astrologers/:astrologerId/commission
   * Update astrologer custom platform commission rate
   */
  @Patch(':astrologerId/commission')
  @RequirePermissions(Permissions.ASTROLOGERS_EDIT)
  async updateCommissionRate(
    @Param('astrologerId') astrologerId: string,
    @CurrentAdmin() admin: any,
    @Body('platformCommissionRate') platformCommissionRate: number,
  ) {
    return this.adminAstrologersService.updateCommissionRate(
      astrologerId,
      admin._id,
