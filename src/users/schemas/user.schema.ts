...
export class User {
  ...
  @Prop({ required: false, default: 'https://AstroSolution.s3.ap-south-1.amazonaws.com/images/row-1-column-1.png' })
  profileImage: string;
  ...
  // === FREE CHAT TRACKING ===
  @Prop({ default: false })
  isAiFirstConsultationUsed: boolean;
  ...
  @Prop({
    type: [{
      ...
      occupation: { type: String, default: 'Employee' },
