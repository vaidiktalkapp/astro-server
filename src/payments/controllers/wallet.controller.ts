...
export class WalletController {
   ...
   */
  @Get('recharge-packs')
  async getRechargePacks(@Req() req: AuthenticatedRequest) {
    const packs = await this.walletService.getActiveRechargePacks(req.user._id);
    return {
      success: true,
      data: packs,
    };
   ...
   * GET /wallet/promo-banner
   */
  @Get('promo-banner')
  @SetMetadata('isPublic', true)
  async getPromoBanner() {
    return this.walletService.getPromoBanner();
  }
