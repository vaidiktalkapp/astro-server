...
export class GiftService {
  ...
  constructor(
    ...
    @InjectModel(SystemSettings.name) private readonly systemSettingsModel: Model<SystemSettingsDocument>,
  ...
  async sendGift(params: SendGiftParams): Promise<{
    ...
    // ✅ Calculate commission split dynamically (Astrologer specific -> Global setting -> Fallback 50%)
    ...
    try {
      ...
      await this.earningsService.recordGiftEarning(astrologerId, amount, astrologerEarning, platformCommission);
